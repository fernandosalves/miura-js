...
class ToolbarDemo extends MiuraElement {
  template() {
    return html`
...
customElements.define('toolbar-demo', ToolbarDemo);

export const Toolbars: StoryObj = {
  name: 'Toolbar',
  render: () => document.createElement('toolbar-demo'),
};
...
class BreadcrumbDemo extends MiuraElement {
  template() {
    return html`
      <div style="display: flex; flex-direction: column; gap: 32px;">
        <div>
...
customElements.define('breadcrumb-demo', BreadcrumbDemo);

export const Breadcrumbs: StoryObj = {
  name: 'Breadcrumb',
  render: () => document.createElement('breadcrumb-demo'),
};
...
class TabsDemo extends MiuraElement {
  template() {
    return html`
      <div style="display: flex; flex-direction: column; gap: 32px;">
        <div>
...
export const Tabs: StoryObj = {
  name: 'Tabs',
  render: () => document.createElement('tabs-demo'),
};
