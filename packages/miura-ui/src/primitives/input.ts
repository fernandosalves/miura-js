// miura-ui: primitives/input.ts
// Mobile-first, token-driven input for MiuraJS
...
export class MuiInput extends MiuraElement {
  ...
  static properties = {
    ...
    status: { type: String, reflect: true, default: 'default' },
  ...
  static get styles() {
    return css`
      :host {
        --mui-input-bg: var(--mui-surface, #fff);
      ...
      input:focus { caret-color: var(--mui-input-border-active); }
